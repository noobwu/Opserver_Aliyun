...
namespace StackExchange.Opserver.Data.SQL
{
    public partial class SQLInstance : PollNode, ISearchableNode
    {
        ...
        protected Task<DbConnection> GetConnectionAsync(int timeoutMs = 10 * 5000) => Connection.GetOpenAsync(ConnectionString, connectionTimeoutMs: timeoutMs);
        ...
        /// </summary>
        /// <param name="timeoutMs">Maximum milliseconds to wait when opening the connection.</param>
        protected DbConnection GetConnection(int timeoutMs = 10*5000) => Connection.GetOpen(ConnectionString, connectionTimeoutMs: timeoutMs);
